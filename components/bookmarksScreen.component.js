            ...
            >
                <SafeAreaView>
                    <ScrollView stickyHeaderIndices={[0]}>
                        ...
                        <Text style={styles.overlayTitleH2}>
                            On y va comment ?
                        </Text>
                        ...
                        <View style={styles.overlayContainerHoraires}>
                            ...
                            <View>
                                ...
                                >
                                    {overlayHoraires[0].slice(
                                        7,
                                        overlayHoraires[0].length
                                    )}
                                </Text>
                                <Text
                                    style={
                                ...
                                >
                                    {overlayHoraires[1].slice(
                                        7,
                                        overlayHoraires[1].length
                                    )}
                                </Text>
                                <Text
                                    style={
                                ...
                                >
                                    {overlayHoraires[2].slice(
                                        10,
                                        overlayHoraires[2].length
                                    )}
                                </Text>
                                <Text
                                    style={
                                ...
                                >
                                    {overlayHoraires[3].slice(
                                        7,
                                        overlayHoraires[3].length
                                    )}
                                </Text>
                                <Text
                                    style={
                                ...
                                >
                                    {overlayHoraires[4].slice(
                                        10,
                                        overlayHoraires[4].length
                                    )}
                                </Text>
                                <Text
                                    style={
                                ...
                                >
                                    {overlayHoraires[5].slice(
                                        8,
                                        overlayHoraires[5].length
                                    )}
                                </Text>
                                <Text
                                    style={
                                ...
                                >
                                    {overlayHoraires[6].slice(
                                        10,
                                        overlayHoraires[6].length
                                    )}
                                </Text>
                            </View>
                        </View>
