  ...
  let comments = suggestions[suggestionNumber].reviews.map((l, i) => {
    ...
    for (let j = 0; j < 5; j++) {
      if (j < Math.round(l.note)) {
        rating.push(
          <AntDesign key={i + j} name="star" size={16} color="#FF8367" />
        );
      } else {
        rating.push(
          <AntDesign key={i + j} name="staro" size={16} color="#FF8367" />
        );
      }
    }
    return (
          ...
          >
            ...
            <View style={styles.containerHoraires}>
              ...
              <View>
                ...
                >
                  {suggestions[suggestionNumber].openingHours[0].slice(
                    7,
                    suggestions[suggestionNumber].openingHours[0].length
                  )}
                </Text>
                <Text
                  style={
                ...
                >
                  {suggestions[suggestionNumber].openingHours[1].slice(
                    7,
                    suggestions[suggestionNumber].openingHours[1].length
                  )}
                </Text>
                <Text
                  style={
                ...
                >
                  {suggestions[suggestionNumber].openingHours[2].slice(
                    10,
                    suggestions[suggestionNumber].openingHours[2].length
                  )}
                </Text>
                <Text
                  style={
                ...
                >
                  {suggestions[suggestionNumber].openingHours[3].slice(
                    7,
                    suggestions[suggestionNumber].openingHours[3].length
                  )}
                </Text>
                <Text
                  style={
                ...
                >
                  {suggestions[suggestionNumber].openingHours[4].slice(
                    10,
                    suggestions[suggestionNumber].openingHours[4].length
                  )}
                </Text>
                <Text
                  style={
                ...
                >
                  {suggestions[suggestionNumber].openingHours[5].slice(
                    8,
                    suggestions[suggestionNumber].openingHours[5].length
                  )}
                </Text>
                <Text
                  style={
                ...
                >
                  {suggestions[suggestionNumber].openingHours[6].slice(
                    10,
                    suggestions[suggestionNumber].openingHours[6].length
                  )}
                </Text>
              </View>
            </View>
