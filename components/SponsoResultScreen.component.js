...
const sponso = {
  ...
  photo:
    "https://www.pariszigzag.fr/wp-content/uploads/2017/11/meilleur-pizza-monde-paris-zigzag-e1510331476865.jpg",
  reviews: [
    {
      auteur: "Jane Dough",
      avatar:
        "https://lh5.ggpht.com/-WAucISfBNng/AAAAAAAAAAI/AAAAAAAAAAA/USFWfso9ct0/s128-c0x00000000-cc-rp-mo-ba4/photo.jpg",
      note: 5,
    ...
    },
    {
      ...
      avatar:
        "https://lh5.ggpht.com/-fwzGjfQuG9M/AAAAAAAAAAI/AAAAAAAAAAA/NDnMpmTw5-c/s128-c0x00000000-cc-rp-mo-ba5/photo.jpg",
      note: 5,
    ...
    },
    {
      ...
      avatar:
        "https://lh4.ggpht.com/-QSAosyYmqBM/AAAAAAAAAAI/AAAAAAAAAAA/ulVtCs4M49o/s128-c0x00000000-cc-rp-mo-ba2/photo.jpg",
      note: 5,
...
function SponsoResultScreen({
  ...
  const B = (props) => (
    <Text style={{ fontFamily: "OpenSans_700Bold" }}>{props.children}</Text>
  );
  ...
  if (!fontsLoaded) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <ImageBackground source={{ uri: sponso.photo }} style={styles.picture}>
          <Header />
          <GestureRecognizer
          ...
          >
            ...
            <View style={styles.containerCard}>
              ...
              <View style={styles.containerRatingOpen}>
                <Text>{rating}</Text>
                {sponso.isOpen === true ? currentlyOpened : currentlyClosed}
              </View>
              ...
              <View style={styles.containerAdress}>
                ...
                />
                <Text style={styles.adressText}>{sponso.adresse}</Text>
              </View>

              <View style={styles.containerBadges}>
                <Badge
                  containerStyle={{ marginRight: 8, marginTop: 8 }}
                  value={<Text style={styles.badgeText}>{sponso.type}</Text>}
                  badgeStyle={styles.badgeStyle}
                />
              </View>

              <Text style={styles.description}>
                Pour déguster la meilleure pizza du monde, inutile de se rendre
                en Italie. Il suffit de faire un détour par{" "}
                <B>Yo Mamma Pizza !</B>, où Giuseppe Cutraro, alias Peppe, vient
                d'ouvrir sa pizzeria..
              </Text>
            </View>
          </GestureRecognizer>
        </ImageBackground>
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    setShakeCount: function (value) {
      dispatch({ type: "setShakeCount", value: value });
    },
  };
}
